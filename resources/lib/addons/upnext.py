...
from resources.lib.model import Args, EpisodeData, SeriesData

from . import utils

def send_next_info(args: Args, current_episode: EpisodeData, next_episode: EpisodeData, play_url: str, notification_offset: int | None = None, series: SeriesData | None = None):
    """
    ...
    upnext_signal(args.addonid, next_info)

class UpnextEpisode:
    def __init__(self, dto: EpisodeData, series_dto: SeriesData | None):
